# -*- coding: utf-8 -*-
"""敌人页字段审计：prts.wiki 模板上有哪些参数，我们入了库、哪些没入。
...
prts.wiki 的敌人模板是站内编辑维护的，**随时可能加参数**（比如新出一类抗性、
...
_NOT_BATTLE = {
    ...
    "描述": "图鉴风味文本（剧情文案）。2026-09-17 博士裁定不入库——"
            "**注意只有图鉴级这一处**：逐档的 `描述` 里混着能力正文（如"
            "「未被阻挡时受到的物理或法术伤害减少50%」只写在那里），照旧入库，"
            "见 `_LEVEL_MAP`。",
}
