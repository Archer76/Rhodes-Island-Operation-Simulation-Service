...
* 敌人侧的正文来自 **PRTS 的 wikitext**，还夹着一层 wiki 模板
...
#: gamedata 的游戏内正文会写「造成二次伤害」，中文数字是真数值；而 PRTS 的敌人
...
ENEMY_RULES: tuple[Rule, ...] = (
    ...
    # gamedata 的正文本来就是那样写的。**PRTS 的敌人正文是手写的**，
    ...
    # ---- 元素损伤。**PRTS 手写的敌人正文不写数值**（「造成一定侵蚀损伤」），
